...
export default function About() {
  return (
    ...
    <header>
        <h1><span class="blue">Prakash</span> Kumar</h1>
    ...
    <div class="introduction_and_details">
        ...
        <div class="details">
            <h2 className='h2'>Name : <span>Prakash Kumar</span></h2>
            <h2 className='h2'>Goal : <span>Front End Developer</span></h2>
            <h2 className='h2'>College : <span class="school">Makhanlal Chaturvedi University</span></h2>
            <h2 className='h2'>Email : <span>Prakashkr4881@gmail.com</span></h2>
            {/* <a class="resume"
