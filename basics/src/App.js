// React Introduction ==>>   React JS is a Client side Javascript library for building User Interfaces . 
//                           It is maintained by  Facebook  and it play with  Virtual DOM. This is 
//                           very fast due to  Virtual DOM. that's why react is more popular to other Framework 
//                           && Library. React has component based Architecture for application Development . 

// Components :=   Header, Footer, section, aside, Navbar  etc  everything  is a component .
...
// using <> and </> , when we write something above on  div .
    ...
    <div className="App">
      <header className="App-header">
        ...
        <p>Today we are starting React with Vasanth sir .</p>
